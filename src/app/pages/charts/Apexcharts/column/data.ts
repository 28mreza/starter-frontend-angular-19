 ...
 */
const columnWithDataChart: ChartOptions = {
  series: [{
    name: "Inflation",
 ...
 */
const StackedColumnChart: ChartOptions = {
  series: [{
    name: "PRODUCT A",
  ...
  colors: ["#5ea3cb", "#6ada7d", "#f7cc53", "#f34e4e"],
};

/**
 * Stacked Column 100
 */
const StackedColumn100Chart: ChartOptions = {
  series: [{
    name: "PRODUCT A",
  ...
  colors: ["#5ea3cb", "#6ada7d", "#f7cc53"],
};

/**
 * Column with Markers
 */
const ColumnWithMarkerChart: ChartOptions = {
  series: [{
    name: "Actual",
    data: [{
            x: "2011",
 ...
 */
const ColumnWithRotatedChart: ChartOptions = {
  series: [{
    name: "Servings",
 ...
 */
const ColumnWithNagetiveChart: ChartOptions = {
  series: [{
    name: "Cash Flow",
    data: [
        1.45,
 ...
 * Range Column Chart
 */
const rangeColumnChart: ChartOptions = {
  series: [{
    data: [{
            x: "Team A",
            y: [1, 5],
 ...
 */
const dynamicQuarterLoadedChart: ChartOptions = {
 ...
 */
const distributedColumnChart: ChartOptions = {
  series: [{
